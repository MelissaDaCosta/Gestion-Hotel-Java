...
public class ChambreModel{
	...
	public ChambreModel(Client client){
	...
	public int chambreProposee(){
		...
		try{
			...
			try{// deuxième requette cherhcer chambre qui correspond aux preferences client (a ala catégorie souhaité)
				Connection co= DriverManager.getConnection("jdbc:mariadb://dwarves.arda/trugeon", "trugeon", "npsm13");
...
/****************************************************************************************/
	...
	public void insererClient(int num){  // insere le client dans notre BD
