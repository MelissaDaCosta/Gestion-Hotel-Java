...
public class InterfaceListe extends JPanel{
	...
	public InterfaceListe(CardLayout card, JPanel pann, Client client, int[] tab, ChambreModel chambremod){
		this.panneau= pann;
	...
	public void afficherVue(){
		...
		ControleurRadioBouton controleurjr= new ControleurRadioBouton(this.moncardlayout, this.panneau, this.monclient, this.chambremodel);
