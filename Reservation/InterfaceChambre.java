...
public class InterfaceChambre extends JPanel{
	...
	public InterfaceChambre(CardLayout card, JPanel pann, Client client, Chambre chambre, ChambreModel chambremod){
		this.panneau= pann;
	...
	public void afficherVue(){
		...
		ControleurChambre controleur= new ControleurChambre(this.moncardlayout, this.panneau, this.monclient, this.chambremodel);
